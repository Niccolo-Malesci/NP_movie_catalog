        ...
        <div class="carousel-inner" style="margin-left: 11%;">
          <div :class="['carousel-item', index === currentSlideIndex ? 'active' : '']"
            ...
            <div class="row" style="width: 95%;">
                <router-link to="/dettaglio/{{currentCategory}}/{{media.id}}" v-for="(media, mediaIndex) in recommended" :key="mediaIndex" class="col-md-2" @click="fetchMediaDetails(media.id, this.currentCategory)">
