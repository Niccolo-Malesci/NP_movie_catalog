        ...
        <div class="col-md-8">
          <div class="card-body">
            ...
            <p v-if="media.title" class="card-text" style="color: white; position: absolute; bottom: 0; right: 0; margin: 10px;">
              Durata: {{ media.runtime }} minuti <br> {{ $t('mediaDetails.dateOfPublication') }}: {{ media.release_date }}
            </p>
            <p v-else class="card-text" style="color: white; position: absolute; bottom: 0; right: 0; margin: 10px;">
              Numero totale di episodi: {{ media.number_of_episodes }} <br> {{ $t('mediaDetails.dateOfPublication') }}: {{ media.first_air_date }}
            </p>
          </div>
        </div>
      </div>
